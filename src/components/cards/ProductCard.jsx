...
import './ProductCard.css';  // Importing the sliding animation CSS

export const ProductCard = ({ item, className }) => {
  return (
    <>
      <div className={`bg-white shadow-s1 rounded-xl p-3 ${className}`}>
...
ProductCard.propTypes = {
  item: PropTypes.any,
  className: PropTypes.string,  // Added to allow passing animation classes
};
